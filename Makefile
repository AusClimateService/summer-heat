...
IO_OPTIONS=--variables ${VAR} --spatial_coords -44 -11 113 154 --time_freq Q-NOV --time_agg ${TIME_AGG} --season ${SEASON} --shapefile ${SHAPEFILE} --spatial_agg ${SPATIAL_AGG} --units ${UNITS} --units_timing middle ${MODEL_IO_OPTIONS}
