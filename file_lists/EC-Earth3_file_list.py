...
for year in np.arange(1960, 2017 + 1):
    infiles1 = glob.glob(f'{file_dir}/s{year}-*/Amon/tas/gr/v20201216/*.nc')
    infiles2 = glob.glob(f'{file_dir}/s{year}-*/Amon/tas/gr/v20201215/*.nc')
    infiles3 = glob.glob(f'{file_dir}/s{year}-*/Amon/tas/gr/v20200508/*.nc')
